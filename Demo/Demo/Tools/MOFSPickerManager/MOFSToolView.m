...
#define LINE_COLOR [UIColor colorWithRed:1  green:1  blue:1 alpha:0]
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _cancelBar.font = [UIFont systemFontOfSize:15];
        _cancelBar.textColor = BaseFontColor;
        _cancelBar.text = @"取消";
        ...
        _commitBar.font = [UIFont systemFontOfSize:15];
        _commitBar.textColor = BaseFontColor;
        _commitBar.text = @"完成";
...
- (void)setCancelBarTintColor:(UIColor *)cancelBarTintColor {
    ...
    if (self.cancelBar) {
        self.cancelBar.tintColor = WZTextColor;
    }
}
...
- (void)setCommitBarTintColor:(UIColor *)commitBarTintColor {
    ...
    if (self.commitBar) {
        self.commitBar.tintColor = BaseFontColor;
    }
}
