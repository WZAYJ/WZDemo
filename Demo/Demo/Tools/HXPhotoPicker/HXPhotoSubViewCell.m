...
- (void)setModel:(HXPhotoModel *)model {
    ...
    if (model.type == HXPhotoModelMediaTypeCamera) {
        ...
        if (model.networkPhotoUrl) {
            ...
            weakSelf.progressView.hidden = YES;
//        sd_setImageWithURL:[NSURL URLWithString:urlStr]
//        placeholderImage:nil
//        options:SDWebImageRefreshCached
            [weakSelf.imageView sd_setImageWithURL:model.networkPhotoUrl placeholderImage:[HXPhotoTools hx_imageNamed:@"qz_photolist_picture_fail@2x.png"] options:SDWebImageRefreshCached];
